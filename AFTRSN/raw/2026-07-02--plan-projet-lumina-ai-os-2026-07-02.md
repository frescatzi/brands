...
source_url: "drive:1wx7lkfaKbyYMZP6VCFLtG5DWjXNnDhl-"
captured: 2026-07-02
vault: brands
brand: AFTRSN
immutable: true
...
# PLAN DE PROJET — LUMINA AI OS (v2.8, état consolidé au 2026-07-02)
...
- ⬜ Étape 4b : récursion Drive (autres PDF) + branche markdown (Obsidian `brands/aftrsn`)
- ⬜ Boucle procédurale (scoring) ; timestamp `created_at` pour consolidation incrémentale (actuel : ORDER BY id DESC LIMIT 50)
...
- ⬜ Vague 2 : Comptable & finance · Qualité & compliance · Content (upgrade de Channel-Content)
...
**⬜ Reste à faire (prochaine session, dans l'ordre) :**
12. Rapatriement documentaire (~30 POS/SOP anciens) + étape 4b mémoire + **ménage** : marque `demo` de test, workflows `__tmp_*`
13. Vague 2 des agents (Comptable/finance, Qualité/compliance, Content)
14. PLAYBOOK v2 : cloner le roster d'agents par script ; skills sur la banque de la marque active
15. (Optionnel) consolidation incrémentale (`created_at`) ; dédup insights ; seuil de similarité skills

---
*PLAN v2.8 — 2026-07-02, rédigé par Claude (Cowork). Ajout v2.8 : point 11 fait — LUMINA-PLAYBOOK v1 (multi-marques : provisioning + brand_profiles + tables généralisées, validé marque démo). Reste : nettoyage, vague 2, PLAYBOOK v2 (clonage roster par script). Sources : docs recouvrés 29-06→01-07, passation 02-07, audit + câblage n8n live.*
